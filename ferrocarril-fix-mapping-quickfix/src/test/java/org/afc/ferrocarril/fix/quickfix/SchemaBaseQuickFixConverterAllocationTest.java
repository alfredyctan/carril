...
public class SchemaBaseQuickFixConverterAllocationTest {
	...
	public void testParse() {
		...
		try {
			SchemaBaseQuickFixConverter fixConverter = new SchemaBaseQuickFixConverter("../ferrocarril-fix-testing/src/main/resources/schema/conv-schema-allocation.xml");
