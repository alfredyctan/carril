...
public class AllocationTestCaseFactory {
	...
	public static Allocation createAllocationObjectAsInput(int i) throws ParseException {		
		...
		allocation.setContext(new FixBaseMessage.Context("Fix.4.2", "INTFXSTR2", "AFCUKFix"));
	...
	public static Allocation createAllocationObjectAsExpected(int i) throws ParseException {
		...
		allocation.setContext(new FixBaseMessage.Context("Fix.4.2", "J", "INTFXSTR2", "AFCUKFix", 100, DateUtil.parseUTCTimestamp("2011-08-09 10:56:12.345")));
		return allocation;
	}
